...
header("Content-type:text/html;charset=utf-8");
	...
	// Edit this ->
	define( 'MQ_SERVER_ADDR', '103.45.175.244' );
...
<body>
    <div class="container">
    	<div class="jumbotron">
			...
			<p>
				<a class="btn btn-large btn-primary" href="https://xpaw.me">由xPaw制造</a>
				<a class="btn btn-large btn-primary" href="https://github.com/xPaw/PHP-Minecraft-Query">在GitHub上查看</a>
				<a class="btn btn-large btn-danger" href="https://github.com/xPaw/PHP-Minecraft-Query/blob/master/LICENSE">MIT执照</a>
			</p>
		</div>
...
<?php else: ?>
		<div class="row">
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							<th colspan="2">服务器状态 <em>(访问延迟/时间 <?php echo $Timer; ?>s)</em></th>
						</tr>
					</thead>
					<tbody>
<?php if( $Info !== false ): ?>
